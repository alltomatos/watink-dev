...
// Note: display logic matches the original RolePermissionTransferList.
//   - Primary text: description ?? name
//   - Secondary text: description is truthy → show name; otherwise null
// ---------------------------------------------------------------------------
        ...
        {items.length === 0 ? (
          ...
          <ul role="list" className="divide-y divide-border">
            {items.map((item) => {
              ...
              // Original logic: description is primary, name is secondary
...
export default function RolePermissionTransferList({
  ...
  // Original RolePermissionTransferList only filters by name and description
