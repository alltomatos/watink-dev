...
const useStyles = makeStyles((theme) => ({
    ...
    statusOpen: { backgroundColor: theme.palette.info.main, color: "var(--bg-surface)" },
    statusInProgress: { backgroundColor: theme.palette.warning.main, color: "var(--bg-surface)" },
    statusPending: { backgroundColor: theme.palette.grey[500], color: "var(--bg-surface)" },
    statusResolved: { backgroundColor: theme.palette.success.main, color: "var(--bg-surface)" },
    statusClosed: { backgroundColor: theme.palette.grey[700], color: "var(--bg-surface)" },
    priorityLow: { backgroundColor: theme.palette.grey[400], color: "var(--bg-surface)" },
    priorityMedium: { backgroundColor: theme.palette.info.main, color: "var(--bg-surface)" },
    priorityHigh: { backgroundColor: theme.palette.warning.main, color: "var(--bg-surface)" },
    priorityUrgent: { backgroundColor: theme.palette.error.main, color: "var(--bg-surface)" },
}));
